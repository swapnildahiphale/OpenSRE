...
// GET /api/admin/orgs/:orgId/stats - Get organization statistics
export async function GET(
  ...
  try {
    ...
    const upstreamUrl = new URL(`/api/v1/admin/orgs/${orgId}/stats`, baseUrl);
    ...
    return NextResponse.json(
      { error: "Failed to get organization stats", details: err?.message || String(err) },
      { status: 502 },
    );
  }
}
